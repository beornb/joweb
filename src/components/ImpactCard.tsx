...
const titleSpanVariants = {
  rest: {
    WebkitTextFillColor: "rgb(255,172,116)", // Ensures gradient from classes is visible
...
export default function ImpactCard({ title, subtitle, text, extraLine }: ImpactCardProps) {
  return (
    <motion.div
      ...
      className="border-3 border-(--rose-gold-fg-dark) p-6 rounded-3xl  shadow-md md:w-1/3"
    ...
    >
      ...
      <h3>
        <motion.span
          ...
          className="text-7xl font-semibold mb-2 text-mid bg-clip-text"
