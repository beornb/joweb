        ...
        <div className="flex flex-col md:flex-row gap-8">
          ...
          <div className="md:w-3/4 text-left flex flex-col md:grid md:grid-cols-2 gap-8 relative"> {/* Changed to grid layout for md screens */}
            ...
            <div className="flex flex-col gap-8 h-full"> {/* Wrapper for 2nd and 3rd cards */}
              <ProjectCard title="Virtual Tour" subtitle="PMM | Product Designer"  no={2} className="flex-1" color="white" projectLink="#" /> 
              {/* projectLink="/projects/virtual-tour" */}
              <ProjectCard title="Peers Selection" subtitle="Product Designer"  no={3} className="flex-1" color="black" projectLink="#" />
              {/* projectLink="/projects/virtual-tour" */}
            </div>
          </div>
        </div>
